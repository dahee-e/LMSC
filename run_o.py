...
parser.add_argument('--steiner', default="max")
...
if args.algorithm == 'IGA':
    best_graph,best_lsm,C = IGA_opt.run(G, args.q, args.l, args.h, args.t,args.steiner)
    run_time = time.time() - start_time
    # print("[OPT] run time ", run_time)

elif args.algorithm == 'SMA':
    if args.naive == False:
        best_graph,best_lsm,C = SMA_opt.run(G, args.q, args.l, args.h, args.t,args.steiner)
    run_time = time.time() - start_time
    # print("[OPT] run time ", run_time)
